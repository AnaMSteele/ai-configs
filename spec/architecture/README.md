...
|---------|----------|--------|-------------|
| OpenCode `review:plan` wrapper | [opencode-review-plan-wrapper.md](./opencode-review-plan-wrapper.md) | ✅ Implemented | Adds a first-class OpenCode `review:plan` entrypoint that fans out to the existing GPT5.5 and Kimi review flows without auto-integrating comments. |
