...
# Deprecated Kimi Review Alias

Standard Pi review gates no longer use Kimi for plan, implementation, or PR reviews. This alias runs inside the Pi `quality-reviewer-glm` subagent instead.

Do not launch Kimi, OMP, Codex CLI, Claude Code, or any external reviewer.
